...
const executionNodes: NodeTypeOption[] = [
    ...
    },
    {
        ...
        label: "Gemini",
        description: "Use Google Gemini models to generate text",
        icon: "/gemini.svg",
    },
    {
        type: NodeType.OPENAI,
        label: "OpenAI",
        description: "Use OpenAI models to generate text",
        icon: "/openai.svg",
    },
    {
        type: NodeType.ANTHROPIC,
        label: "Anthropic",
        description: "Use Anthropic models to generate text",
        icon: "/anthropic.svg",
    },
    {
    ...
    const handleNodeSelect = useCallback((selection: NodeTypeOption) => {
        ...
        setNodes((nodes) => {
            ...
            if (hasInitialTrigger) {
                // no need to append to the list of nodes, want to replace the existing initial trigger with the new node.
